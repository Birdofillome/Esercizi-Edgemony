    ...
    <>
      ...
      <main className={style.main}>
        ...
        <WindowBox title="Story Params">
          ...
          <InputBox label="Nome Protagonista:" 
          value={protagonista} 
          setValue={setProtagonista}/>
          <InputBox label="Nome Antagonista:" 
          value={antagonista} 
...
<SelectBox label="Seleziona Genere:" list={ListaGeneri} setAction={setGenere}/>
    ...
    <Button label="Genera" onClick={handeGenerate} disabled={protagonista.trim().length <= 0 && antagonista.trim().length <= 0 && genere.trim().length <= 0}/> 
          </WindowBox>
        </div>
      </main>
    </>
